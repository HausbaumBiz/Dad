...
export default function EducationTutoringPage() {
  ...
  useEffect(() => {
    async function fetchBusinesses() {
      setLoading(true)
      try {
        const response = await fetch("/api/businesses/by-page?page=education-tutoring")
        if (response.ok) {
      ...
      <div className="space-y-6">
        {loading ? (
          ...
          <div className="text-center py-12">
            <p className="text-gray-600 mb-4">No education and tutoring service businesses found.</p>
