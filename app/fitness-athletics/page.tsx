  ...
  useEffect(() => {
    const fetchBusinesses = async () => {
      try {
        ...
        const response = await fetch("/api/businesses/by-page?page=fitness-athletics")
        ...
        if (data.success && data.businesses) {
          ...
          console.warn("No businesses found for fitness-athletics page")
          setBusinesses([])
        }
      } catch (error) {
        ...
        toast({
          ...
          description: "Failed to load fitness and athletics businesses. Please try again later.",
          variant: "destructive",
        })
      } finally {
        setLoading(false)
      ...
      {businesses.length === 0 ? (
        <div className="text-center py-12">
          <div className="text-gray-600 mb-4">
            <p className="text-lg font-semibold">No fitness and athletics businesses found</p>
            <p className="text-sm">Be the first to register your fitness business!</p>
          </div>
