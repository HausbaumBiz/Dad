...
export default function NonMedicalCareJobsPage() {
  return (
    <JobCategoryLayout
      title="Non-Medical Care Giver Jobs"
    ...
    >
      ...
      <div className="text-center py-12 bg-white rounded-lg shadow-sm">
        ...
        <h2 className="text-2xl font-semibold text-gray-800 mb-2">No Care Giver Jobs Available</h2>
        <p className="text-gray-600 mb-4">There are currently no non-medical care giver job listings in this area.</p>
