...
export default function ProtectionServicesJobsPage() {
  return (
    <JobCategoryLayout
      title="Protection Services Jobs"
    ...
    >
      ...
      <div className="text-center py-12 bg-white rounded-lg shadow-sm">
        ...
        <h2 className="text-2xl font-semibold text-gray-800 mb-2">No Protection Services Jobs Available</h2>
        <p className="text-gray-600 mb-4">There are currently no protection services job listings in this area.</p>
