  ...
  return (
    <div className="container mx-auto py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white rounded-lg shadow p-6">
          <h2 className="text-xl font-semibold mb-4">Inspect Categories</h2>
          <p className="text-gray-600 mb-4">Inspect how categories are stored in Redis and debug category issues.</p>
          <a href="/admin/inspect-categories" className="text-blue-600 hover:text-blue-800">
            Inspect Categories →
          </a>
        </div>
      </div>
