...
export default function TrashCleanupPage() {
  ...
  useEffect(() => {
    const fetchProviders = async () => {
      ...
      setError(null)
      try {
        const response = await fetch(`/api/businesses/by-page?page=home-improvement-trash-cleanup`)
        if (!response.ok) {
  ...
  return (
    <CategoryLayout title="Trash Cleanup and Removal" backLink="/home-improvement" backText="Home Improvement">
      ...
      {isLoading ? (
        ...
        <div className="text-center py-12">
          <p className="text-gray-500 mb-2">No trash cleanup businesses found.</p>
