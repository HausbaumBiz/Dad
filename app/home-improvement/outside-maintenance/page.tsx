          ...
          result.map(async (business) => {
            try {
              ...
              if (adDesignData?.businessInfo?.phone) {
                ...
                console.log(`Found phone in ad design for ${business.displayName}: ${displayPhone}`)
              } else if (business.phone) {
                displayPhone = business.phone
                console.log(`Using registration phone for ${business.displayName}: ${displayPhone}`)
              } else {
                console.log(`No phone found for ${business.displayName}`)
              }
