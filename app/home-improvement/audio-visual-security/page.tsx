...
export default function AudioVisualSecurityPage() {
  ...
  useEffect(() => {
    const fetchProviders = async () => {
      try {
        const response = await fetch("/api/businesses/by-page?page=audio-visual-security")
        if (!response.ok) {
        ...
        {loading ? (
          ...
          <div className="text-center py-10">
            <p className="text-gray-700 mb-4">
              No audio/visual and home security businesses found. Be the first to register your business in this
              category!
            </p>
