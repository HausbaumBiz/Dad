...
export default function InsideMaintenancePage() {
  ...
  useEffect(() => {
    const fetchProviders = async () => {
      ...
      setError(null)
      try {
        const response = await fetch(`/api/businesses/by-page?page=home-improvement-inside-maintenance`)
        if (!response.ok) {
  ...
  return (
    <CategoryLayout title="Inside Home Maintenance and Repair" backLink="/home-improvement" backText="Home Improvement">
      ...
      {isLoading ? (
        ...
        <div className="text-center py-12">
          <p className="text-gray-500 mb-2">No inside maintenance businesses found.</p>
