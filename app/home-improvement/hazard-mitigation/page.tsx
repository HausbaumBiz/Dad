...
export default function HazardMitigationPage() {
  ...
  const filterOptions = [
    { id: "hazard1", label: "Mold Remediation", value: "Mold Remediation" },
    { id: "hazard2", label: "Asbestos Removal", value: "Asbestos Removal" },
    { id: "hazard3", label: "Lead Paint Removal", value: "Lead Paint Removal" },
    { id: "hazard4", label: "Water Damage Restoration", value: "Water Damage Restoration" },
    { id: "hazard5", label: "Fire Damage Restoration", value: "Fire Damage Restoration" },
    { id: "hazard6", label: "Radon Testing & Mitigation", value: "Radon Testing & Mitigation" },
    { id: "hazard7", label: "Other Hazard Mitigation", value: "Other Hazard Mitigation" },
  ]
  ...
  return (
    <CategoryLayout title="Hazard Mitigation" backLink="/home-improvement" backText="Home Improvement">
          ...
          <div className="text-center py-12">
            ...
            <p className="text-gray-600 mb-6">
              {userZipCode
                ...
                : "Be the first hazard mitigation specialist to join our platform and help local customers with safety needs!"}
            </p>
            <Button>Register Your Hazard Mitigation Business</Button>
          </div>
        ) : (
