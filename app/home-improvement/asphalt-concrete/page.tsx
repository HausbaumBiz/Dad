...
export default function AsphaltConcretePage() {
  ...
  useEffect(() => {
    async function fetchBusinesses() {
      setLoading(true)
      try {
        const response = await fetch("/api/businesses/by-page?page=asphalt-concrete")
        if (response.ok) {
        ...
        {loading ? (
          ...
          <div className="text-center py-10">
            <p className="text-gray-700 mb-4">
              No asphalt, concrete, stone and gravel businesses found. Be the first to register your business in this
              category!
            </p>
