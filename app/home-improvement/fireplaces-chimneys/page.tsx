...
export default function FireplacesChimneysPage() {
  ...
  useEffect(() => {
    const fetchProviders = async () => {
      setLoading(true)
      try {
        const response = await fetch("/api/businesses/by-page?page=fireplaces-chimneys")
        if (!response.ok) {
        ...
        {loading ? (
          ...
          <div className="text-center py-10">
            <p className="text-gray-700 mb-4">
              No fireplaces and chimneys businesses found. Be the first to register your business in this category!
            </p>
