...
export default function LawnGardenPage() {
  const filterOptions = [
    ...
    { id: "lawn2", label: "Landscaping", value: "Landscaping" },
    { id: "lawn3", label: "Tree Service", value: "Tree Service" },
    { id: "lawn4", label: "Irrigation", value: "Irrigation" },
    { id: "lawn5", label: "Other Lawn and Garden", value: "Other Lawn and Garden" },
  ]
  ...
  useEffect(() => {
    const fetchProviders = async () => {
      setLoading(true)
      try {
        const response = await fetch("/api/businesses/by-page?page=lawn-garden")
        if (!response.ok) {
  ...
  return (
    <CategoryLayout title="Lawn and Garden" backLink="/home-improvement" backText="Home Improvement">
        ...
        {loading ? (
          ...
          <div className="text-center py-10">
            <p className="text-gray-700 mb-4">
              No lawn and garden businesses found. Be the first to register your business in this category!
            </p>
