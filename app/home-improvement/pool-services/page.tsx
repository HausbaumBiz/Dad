...
export default function PoolServicesPage() {
  ...
  useEffect(() => {
    const fetchProviders = async () => {
      ...
      setError(null)
      try {
        const response = await fetch(`/api/businesses/by-page?page=home-improvement-pool-services`)
        if (!response.ok) {
  ...
  return (
    <CategoryLayout title="Pool Services" backLink="/home-improvement" backText="Home Improvement">
      ...
      {isLoading ? (
        ...
        <div className="text-center py-12">
          <p className="text-gray-500 mb-2">No pool service businesses found.</p>
