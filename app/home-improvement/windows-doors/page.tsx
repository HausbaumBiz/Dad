...
export default function WindowsDoorsPage() {
  ...
  useEffect(() => {
    const fetchProviders = async () => {
      ...
      setError(null)
      try {
        const response = await fetch(`/api/businesses/by-page?page=home-improvement-windows-doors`)
        if (!response.ok) {
  ...
  return (
    <CategoryLayout title="Windows and Doors" backLink="/home-improvement" backText="Home Improvement">
      ...
      {isLoading ? (
        ...
        <div className="text-center py-12">
          <p className="text-gray-500 mb-2">No windows and doors businesses found.</p>
